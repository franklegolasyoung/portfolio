    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <p>Developed Image Storage, Sharing, and Cooperation Platform, built with Spring Boot, Vue, MySQL, Redis, AWS, COS Storage, Kafka, CDN Acceleration</p>
            </div>
            <div className="project">
                ...
                <p>Developed RAG-Agent system for equities research, integrating multi-source market news and prices, RAG retrieval and reranking, AWS RDS PostgreSQL, and structured LLM reasoning to produce traceable investment insights.</p>
            </div>
            <div className="project">
                ...
                <p>Published research on LLM security vulnerabilities and privacy leakage. Accepted by AAAI-26 Special Track on AI Alignment. Introduced CoSPED framework for consistent soft prompt targeted data extraction, achieving 65.2% extraction rate, and demonstrated effective defense strategies reducing extraction to 1.6%.</p>
            </div>
            <div className="project">
                ...
                <p>Developed and worked as key maintainer and contributor to Linux Snap Store extension for Zotero, enabling users to install and control Zotero in Linux Environment more conveniently.</p>
            </div>
        </div>
    </div>
    );
